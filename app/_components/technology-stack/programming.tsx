...
export default function Programming() {
  return (
    <section className="text-left">
      <BlurFade inView>
        <TypographyMuted>Programming</TypographyMuted>
      </BlurFade>
      ...
      <ul className="my-1">
        <ListItem>
          ...
          <TypographyP>JavaScript ⭐️</TypographyP>
        </ListItem>
        <ListItem>
          <svg className="size-5" viewBox="0 0 128 128">
            <g>
          ...
          <TypographyP>TypeScript ⭐️</TypographyP>
        </ListItem>
        <ListItem>
          <svg className="size-5" viewBox="0 0 128 128">
            <linearGradient
          ...
          <TypographyP>Python</TypographyP>
        </ListItem>
        <ListItem>
          <svg className="size-5" viewBox="0 0 128 128">
            <g>
        ...
        <ListItem>
          <svg className="size-5" viewBox="0 0 128 128">
            <g>
              ...
              />
              <g fill="#fff">
                <path d="M82.1 61.8h5.2v-5.3h4.4v5.3h5.3v4.4size-5.3v5.2h-4.4v-5.2size-5.2v-4.4zM100.6 61.8h5.2v-5.3h4.4v5.3h5.3v4.4size-5.3v5.2h-4.4v-5.2size-5.2v-4.4z" />
              </g>
            </g>
          </svg>
          <TypographyP>C/C++</TypographyP>
        </ListItem>
        <ListItem>
